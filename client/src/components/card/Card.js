  ...
  return (
    ...
    >
      ...
      {/* background opaque 70% */}
        <i className={item.type == 'audio'? "fa fa-headphones p-2": "fa fa-play-circle p-2"} style={{position:"absolute", top:"1%", left:"1%", fontSize:"20px", color:"white", backgroundColor:"rgba(0,0,0,0.7)", borderRadius:"10%"}}></i>
      </div>
      <div className="card-body p-0 pt-2">
        <div className="d-flex flex-row">
          ...
          <div className="px-2">
            <span className="py-2" onClick={handleCLick} style={{cursor: "pointer"}}>
