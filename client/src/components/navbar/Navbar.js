...
const Navbar = () => {
  ...
  return (
    <div
      className="flex justify-between px-3 py-3 bg-cyan-900/10 rounded-b-xl"
    ...
    >
      ...
      <div className="flex justify-center">
        ...
        />
        <button
          className="btn btn-outline-success my-2 my-sm-0 ml-2 searchBtn"
      ...
      <div className="flex gap-x-2">
        <a
          className="w-full border-2 border-cyan-600 text-cyan-600 flex justify-between items-center gap-x-3 px-3 cursor-pointer font-[monospace] rounded hover:bg-cyan-600 hover:text-white duration-500"
          href="/room"
        >
          /room
        </a>
        ...
        <div className="dropdown">
          <button
            className="w-full border-2 border-cyan-600 text-cyan-600 flex justify-between items-center gap-x-3 px-3 py-[6px] cursor-pointer font-[monospace] rounded hover:bg-cyan-600 hover:text-white duration-500 dropdown-toggle"
            type="button"
